...
public class Paises
{
    ...
    private Paises(Ddi ddi, string siglaIso, string moeda, string simboloMoeda, string pais)
    {
        Ddi = ddi;
        SiglaIso = siglaIso;
        Moeda = moeda;
    ...
    public Paises(int id, Ddi ddi, string siglaIso, string moeda, string simboloMoeda, string pais)
        : this(ddi, siglaIso, moeda, simboloMoeda, pais)
    {
        Id = id;
    }

    public static Resultado<Paises> Criar(Ddi ddi, string siglaIso, string moeda, string simboloMoeda, string pais)
    {
    ...
    public Resultado<Paises> AtualizarResultado(Ddi ddi, string siglaIso, string moeda, string simboloMoeda, string pais)
    {
        var validation = ValidarDados(ddi, siglaIso, moeda, simboloMoeda, pais,
            out var normalizedDdi,
            out var normalizedSiglaIso,
