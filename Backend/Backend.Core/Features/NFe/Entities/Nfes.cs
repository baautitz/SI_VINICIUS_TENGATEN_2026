...
public class Nfes
{
        ...
        NfesInformacoesAdicionais? nfesInformacoesAdicionais = null)
    {
        ...
        EmitenteCpfCnpj = TextNormalization.Normalize(emitente.CpfCnpj);
        EmitenteRgIe = TextNormalization.NormalizeOrNull(emitente.RgIe);
        ...
        ClienteCpfCnpj = TextNormalization.Normalize(cliente.CpfCnpj);
        ClienteRgIe = TextNormalization.NormalizeOrNull(cliente.RgIe);
