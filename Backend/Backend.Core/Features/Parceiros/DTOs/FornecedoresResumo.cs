...
public record FornecedoresResumo
{
    ...
    public FornecedoresResumo() { }

    public FornecedoresResumo(int id, TipoPessoa tipoPessoa, string nomeRazaoSocial, string cpfCnpj, string? apelidoNomeFantasia, int nacionalidadeId)
    {
        Id = id;
