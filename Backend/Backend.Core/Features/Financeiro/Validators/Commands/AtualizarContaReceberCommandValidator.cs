...
public class AtualizarContaReceberCommandValidator : AbstractValidator<AtualizarContaReceberCommand>
{
    public AtualizarContaReceberCommandValidator()
    {
        ...
        RuleForEach(x => x.Parcelas).ChildRules(parcela =>
        {
            ...
            parcela.RuleFor(p => p.ValorRecebido)
