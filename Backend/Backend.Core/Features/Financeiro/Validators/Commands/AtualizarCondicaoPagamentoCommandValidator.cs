...
public class AtualizarCondicaoPagamentoCommandValidator : AbstractValidator<AtualizarCondicaoPagamentoCommand>
{
    public AtualizarCondicaoPagamentoCommandValidator()
    {
