...
CREATE TYPE IF NOT EXISTS projeto_sistemas.tipo_operacao_enum AS ENUM ('ENTRADA', 'SAIDA');
CREATE TYPE IF NOT EXISTS projeto_sistemas.status_nfe_enum AS ENUM ('RASCUNHO', 'EMITIDA', 'CANCELADA');
CREATE TYPE IF NOT EXISTS projeto_sistemas.modalidade_frete_enum AS ENUM (
  'EMITENTE',
  'DESTINATARIO',
  'TERCEIROS',
  'REMETENTE_PROPRIO',
...
CREATE TYPE IF NOT EXISTS projeto_sistemas.indicador_pagamento_enum AS ENUM ('A_VISTA', 'A_PRAZO');
